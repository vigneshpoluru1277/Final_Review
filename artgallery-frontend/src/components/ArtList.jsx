...
export default function ArtList() {
  ...
  const fetchArts = () => {
    axios.get(`${process.env.REACT_APP_API_URL}/api/arts`)
  ...
  const handleUpdate = () => {
    axios.put(`${process.env.REACT_APP_API_URL}/api/arts/${editId}`, editData)
      .then(() => {
        setEditId(null);
        fetchArts();
      })
  ...
  const handleDelete = (id) => {
    if (window.confirm('Are you sure you want to delete this art?')) {
      axios.delete(`${process.env.REACT_APP_API_URL}/api/arts/${id}`)
        .then(() => fetchArts())
